...
![Рисунок 5](image/fig1-2){#fig:005 width=70%}

![Рисунок 6](image/fig2-2){#fig:006 width=70%}

![Рисунок 7](image/fig3-2){#fig:007 width=70%}

![Рисунок 8](image/fig4-2){#fig:008 width=70%}

3. Определим опции команды chmod, необходимые для того, чтобы присвоить
...
![Рисунок 9](image/fig1-3){#fig:009 width=70%}

(рис. [-@fig:010])

![Рисунок 10](image/fig2-3){#fig:010 width=70%}

4. Проделаем приведённые ниже упражнения, записывая в отчёт по лаборатор-
ной работе используемые при этом команды: 
...
![Рисунок 11](image/fig1-4){#fig:011 width=70%}

![Рисунок 12](image/fig2-4){#fig:012 width=70%}

![Рисунок 13](image/fig3-4){#fig:013 width=70%}

![Рисунок 14](image/fig4-4){#fig:014 width=70%}

![Рисунок 15](image/fig4-5){#fig:015 width=70%}

5. Прочитаем man по командам mount, fsck, mkfs, kill. 

(рис. [-@fig:016])

![Рисунок 16](image/fig1-5){#fig:016 width=70%}
